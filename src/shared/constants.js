...
export const C = {
    ...
    DEBOUNCE_MS_SHORT: 100,
    DEBOUNCE_MS_MEDIUM: 200,
    DEBOUNCE_MS_LONG: 400,
    MODE_OFF: 'off',
    ...
    MSG_CHECK_FORM_DIRTY: 'FD_CHECK_FORM_DIRTY',
    MSG_RULES_UPDATED: 'FD_RULES_UPDATED'
};
